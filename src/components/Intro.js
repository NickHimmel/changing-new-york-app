  ...
  return (
    <div className="intro">
      ...
      <div className="intro__inner">
        ...
        <p className="header">Focusing on the Lower Manhattan waterfront and the Brooklyn Bridge Park area, this project uses the New York Public Library API to compare Berenice’s photos to photos I have taken this year and last.</p>
